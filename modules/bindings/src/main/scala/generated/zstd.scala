...
object predef:
  private[zstd] trait _BindgenEnumCUnsignedInt[T](using eq: T =:= CUnsignedInt):
...
object enumerations:
  ...
  object ZSTD_EndDirective extends _BindgenEnumCUnsignedInt[ZSTD_EndDirective]:
    ...
    def getName(value: ZSTD_EndDirective): Option[String] =
      value match
  ...
  object ZSTD_ResetDirective extends _BindgenEnumCUnsignedInt[ZSTD_ResetDirective]:
    ...
    def getName(value: ZSTD_ResetDirective): Option[String] =
      value match
  ...
  object ZSTD_cParameter extends _BindgenEnumCUnsignedInt[ZSTD_cParameter]:
    ...
    def getName(value: ZSTD_cParameter): Option[String] =
      value match
  ...
  */
  ...
  object ZSTD_dParameter extends _BindgenEnumCUnsignedInt[ZSTD_dParameter]:
    ...
    def getName(value: ZSTD_dParameter): Option[String] =
      value match
  ...
  */
  ...
  object ZSTD_strategy extends _BindgenEnumCUnsignedInt[ZSTD_strategy]:
    ...
    def getName(value: ZSTD_strategy): Option[String] =
      value match
...
object structs:
  ...
  object ZSTD_bounds:
    ...
    export fields.*
    private[zstd] object fields:
      extension (struct: ZSTD_bounds)
        inline def error : size_t = struct._1
        inline def error_=(value: size_t): Unit = (!struct.at1 = value)
        inline def lowerBound : CInt = struct._2
        inline def lowerBound_=(value: CInt): Unit = (!struct.at2 = value)
        inline def upperBound : CInt = struct._3
        inline def upperBound_=(value: CInt): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates ZSTD_bounds on the heap – fields are not initalised or zeroed out
  ...
  object ZSTD_inBuffer:
    ...
    private[zstd] object fields:
      extension (struct: ZSTD_inBuffer)
        inline def src : Ptr[Byte] = struct._1
        inline def src_=(value: Ptr[Byte]): Unit = (!struct.at1 = value)
        inline def size : size_t = struct._2
        inline def size_=(value: size_t): Unit = (!struct.at2 = value)
        inline def pos : size_t = struct._3
        inline def pos_=(value: size_t): Unit = (!struct.at3 = value)
      end extension
    
    // Allocates ZSTD_inBuffer on the heap – fields are not initalised or zeroed out
  ...
  */
  ...
  object ZSTD_inBuffer_s:
    ...
    // Allocates ZSTD_inBuffer_s on the heap – fields are not initalised or zeroed out
  ...
  object ZSTD_outBuffer:
    ...
    private[zstd] object fields:
      extension (struct: ZSTD_outBuffer)
        inline def dst : Ptr[Byte] = struct._1
        inline def dst_=(value: Ptr[Byte]): Unit = (!struct.at1 = value)
        inline def size : size_t = struct._2
        inline def size_=(value: size_t): Unit = (!struct.at2 = value)
        inline def pos : size_t = struct._3
        inline def pos_=(value: size_t): Unit = (!struct.at3 = value)
    ...
    // Allocates ZSTD_outBuffer on the heap – fields are not initalised or zeroed out
  ...
  object ZSTD_outBuffer_s:
    ...
    // Allocates ZSTD_outBuffer_s on the heap – fields are not initalised or zeroed out
...
object functions:
  ...
  */
  def ZSTD_cParam_getBounds(cParam : ZSTD_cParameter)(using Zone): ZSTD_bounds =
    val __ptr_0: Ptr[ZSTD_bounds] = _root_.scala.scalanative.unsafe.alloc[ZSTD_bounds](1)
